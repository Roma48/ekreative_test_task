...
<head>
  ...
  <?php print $styles; ?>
  <link type="text/css" rel="stylesheet" media="all" href="<?php print drupal_get_path("module", "node_embed_edsuite") ?>/ckeditor/ck_nodeembed.css" />
  ...
  <script type="text/javascript" src="<?php 
    print base_path() . drupal_get_path('module', 'node_embed_edsuite')?>/ckeditor/ck_nodeembed.js">
  </script>
</head>
